...
class Click:
    ...
    def Check(self, pos):
        ...
        if pos[0] < self.window_width * 0.33 and pos[1] > self.window_height * 0.66:
            return "A3"
        ...
        if self.window_width * 0.66 > pos[0] > self.window_width * 0.33 and pos[1] > self.window_height * 0.66:
            return "B3"
        ...
        if pos[0] > self.window_width * 0.66 and pos[1] > self.window_height * 0.66:
            return "C3"
